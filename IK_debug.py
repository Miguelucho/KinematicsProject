...
## Este archivo IK_debug.py permite poner a prueba mi codigo
#y evaluar si corren todos los componentes adicionales.
...
def test_code(test_case):
    ...
    theta3 = pi / 2 - (angle_b + 0.036) 	# 0.036 accounts for sag in link of -0.054m
